                    ...
                    @if($products->count() > 0)
                        <table class="table table-bordered">
                            ...
                            @foreach($products as $index=>$product)
                                <tr>
                                    <td>{{$index + 1}}</td>
                                    <td><img style="width: 75px" class="img-thumbnail" src="{{$product->image_path}}" alt="product_image"></td>
                                    <td>{{$product->name}}</td>
                                    ...
                                    <td>
                                        @if(auth()->user()->hasPermission('update_products'))
                                            <a href="{{ route('dashboard.products.edit', $product->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        @else
