                            ...
                            @foreach($clients as $index=>$client)
                                <tr>
                                    ...
                                    @if(auth()->user()->hasPermission('create_orders'))
                                        <a href="{{ route('dashboard.clients.orders.create', $client->id) }}" class="btn btn-success btn-sm">@lang('site.add_order')</a>
                                    @else
                                        <button class="btn btn-success btn-sm" disabled>@lang('site.add_order')</button>
                                    @endif
                                    </td>
                                    <td>
                                        @if(auth()->user()->hasPermission('update_clients'))
                                            <a href="{{ route('dashboard.clients.edit', $client->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        @else
